...
apiFetch.setFetchHandler(async (options) => {
  ...
  if (
    process.env.NEXT_PUBLIC_JWT_AUTH_USER &&
    process.env.NEXT_PUBLIC_JWT_AUTH_TOKEN
  ) {
    const userPassword = btoa(
      `${process.env.NEXT_PUBLIC_JWT_AUTH_USER}:${process.env.NEXT_PUBLIC_JWT_AUTH_TOKEN}`
    );
